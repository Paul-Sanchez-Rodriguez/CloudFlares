...
import { TutorDto, UpdateTutorDto } from '../../model/UpdateTutorDto';
import { ViewFuncionaryComponent } from 'src/app/components/pdf/components/view-funcionary/view-funcionary.component';
...
export class BulkAllocationComponent {
  ...
  constructor(private fb: FormBuilder, private bulkAllocationService: BulkAllocationService, private router: Router, public dialog: MatDialog,
